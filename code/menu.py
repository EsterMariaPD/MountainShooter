...
class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/MenuBg.png')  # imagem
        self.rect = self.surf.get_rect(left=0, top=0)  # retangulo para imagem

    def run(self, ):
        pygame.mixer_music.load('./asset/Menu.mp3')
        pygame.mixer_music.play(-1)  # -1 ela toca em looping
        while True:
